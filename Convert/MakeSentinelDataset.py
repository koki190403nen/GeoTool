...
def MakeSentinelDataset(ori_zip_path, out_dir, use_bands=[2,3,4,8], work_dir='./working/'):
    ...
    ori_band_dir = glob.glob(f'{work_dir}/*/GRANULE/*/IMG_DATA/R10m')[0]  # オリジナルのバンドが格納されたディレクトリパス
